...
import { PRODUCT_CREATE_REVIEW_RESET } from "../constannts/productConstans";
import {
  Row,
  Col,
  Image,
...
function ProductScreen() {
  ...
  const redirect = `/login?redirect=/product/${productId}`;
  ...
  const userLogin = useSelector((state) => state.userLogin); //from store
  ...
  }, [dispatch, useEffect, successProductReview]);
  //const match = useParams()
                ...
                <ListGroup.Item>
                  ...
                  {userInfo ? (
                    ...
                    <Message variant="info">
                      Please <Link to={redirect}>Login</Link> to write a review
                    </Message>
                  )}
                </ListGroup.Item>
              </ListGroup>
